...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in maprdb_server_pb2_grpc.py depends on'
...
def add_MapRDbServerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('com.mapr.data.db.MapRDbServer', rpc_method_handlers)
